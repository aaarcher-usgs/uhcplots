...
#' @section Details:
#'
#' Used-Habitat Calibration plots are a new method for model calibration that
#' can be applied across a spectrum of species distribution models (SDMs)
#' (Fieberg et al. In revision for Ecology Letters).
#'
#' @section See also:
#'
#'
